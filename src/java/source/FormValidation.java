...
public class FormValidation {
    ...
    /**
     * Determines whether provided string is numeric and contains only whole
     * number or not.
     *
     * @param str String you want to test
     * @return true only when provided String contains whole number, otherwise
     * return false
     */
    ...
    /**
     * Determines whether provided string contain correct syntax for email
     * address or not.
     *
     * @param str String you want to test
     * @return true only when provided String has correct email syntax,
    ...
    /**
     * Determines whether provided string contain correct syntax for birthnumber
     * or not.
     *
     * @param str String you want to test
     * @return true only when provided String has correct birthnumber syntax,
     * otherwise return false
     */
    ...
    /**
     * Extracts birth day from provided String, expecting provided String is
     * valid birth number.
     *
    ...
    /**
     * Extracts birth month from provided String, expecting provided String is
     * valid birth number.
     *
    ...
    /**
     * Extracts birth year from provided String, expecting provided String is
     * valid birth number.
     *
     * @param str valid birth number which contains birth year
     * @return birth year from provided birth number, only in rage of 1930 to
     * 2029
     */
    ...
    /**
     * Determines whether provided strings are calling code and phone number or
     * not.
     *
     * @param callingCode calling code before the phone number
     * @param str phone number you want to test
     * @return true only when provided String is phone number, otherwise return
     * false
     */
    ...
    /**
     * Strips calling code of provided string, expecting telephone number as
     * parameter
     *
     * @param str valid phone number, when it has calling code before it,
     * calling code shall be stripped
    ...
    /**
     * Iterates through provided Map and when Map value contains any valid phone
     * number, its calling code will be stripped.
     *
     * @param input Map whose value should be containing valid phone number
     * (nothing happens, when no valid phone number is found).
     * @return same Map, but with calling codes of all valid phone numbers
     * stripped
     */
    ...
    /**
     * Extracts sex from provided String, expecting provided String is valid
     * birth number.
     *
     ...
     * Labels as keys as provided Map and as value "" or notFilledStyle,
     * depending on result of validation of each value in provided Map, second
     * is boolean determining whether validation was successful or there were
     * any errors
     */
    ...
    /**
     * Constuctor used for saving two variables from return of formValidation
     * method.
     *
     * @param notFilled contains Map, with same Labels as keys as provided Map
     * and as value "" or notFilledStyle, depending on result of validation of
     * each value in provided Map
     * @param error boolean determining whether validation was successful or
