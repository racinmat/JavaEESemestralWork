...
public class SecurityCheck {
    ...
    /**
     * Constructor of SecurityCheck, saves all info about user currently
     * browsing pages from session variable.
     *
    ...
    /**
     *
     * @return true if user who is currently browsing pages is main admin,
    ...
    /**
     *
     * @return true if user who is currently browsing pages is administrativa,
     * otherwise return false
     */
    ...
    /**
     *
     * @return true if user who is currently browsing pages is pedagog,
     * otherwise return false
     */
    ...
    /**
     *
     * @return true if user who is currently browsing pages is main student,
     * otherwise return false
     */
    ...
    /**
     *
     * @return true if user who is currently browsing pages is main applicant,
     * otherwise return false
     */
    ...
    /**
     *
     * @return true if user who is currently browsing pages has at least main
     * admin rights, otherwise return false
     */
    ...
    /**
     *
     * @return true if user who is currently browsing pages has at least
     * administrativa rights, otherwise return false
     */
    ...
    /**
     *
     * @return true if user who is currently browsing pages has at least pedagog
     * rights, otherwise return false
     */
    ...
    /**
     *
     * @return true if user who is currently browsing pages has at least student
     * rights, otherwise return false
     */
     ...
     *
     * @return true if user who is currently browsing pages has at least
     * applicant rights, otherwise return false
     */
    ...
    /**
     * Determines whether user can access page which called this method or not
     * and if not, redirects user to another page.
     *
     * @param rights which are minimally needed to access page which called this
     * method
     ...
     * and if not, redirects user to another page.
     *
     * @param rights which are the only allowed to access page which called this
     * method
     * @param response needed for redirecting user to other pages
     */
    ...
    /**
     * Controls if page which called this method is accessed by redirect or
     * directly and in case of direct access user is redirected to another page
     *
     * @param response needed for redirecting user to other pages
     */
