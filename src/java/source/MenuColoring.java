...
public class MenuColoring {
     ...
     *
     * @param uri URL address which is used for determining on which page user
     * is right now
     */
    ...
    /**
     *
     * @return substring from URL in constructor, used for determining whether
     * to color column with name of page in header of page or not
     */
