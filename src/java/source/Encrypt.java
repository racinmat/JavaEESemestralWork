...
/**
 * This class has encrypt method. Is used for generating very secure
 * hash of password.
 *
 * @author Azathoth
 */
public class Encrypt {
    ...
    /**
     * Returns SHA256 hash of first provided String with usage of cryptographic
     * salt provided in secons String.
     *
     * @param password String you want to hash
     * @param saltString salt you want to use
     * @return SHA256 hash
     * @throws NoSuchAlgorithmException when it fails to get instance of SHA-256
     * algorithm
     */
    ...
    /**
     * Returns MD5 hash of first provided String with usage of cryptographic
     * salt provided in secons String.
     *
     * @param password String you want to hash
     * @param saltString salt you want to use
     * @return MD5 hash
     * @throws NoSuchAlgorithmException when it fails to get instance of MD5
     * algorithm
     */
