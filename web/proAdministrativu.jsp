        ...
        <div id="column-content" class="column column-content posts">
            ...
            <div id="post-1" class="post-1 post type-post status-publish format-standard hentry category-nezarazene clearfix">
                ...
                <div class="entry-summary">
                    ...
                    <p><a href="applicants?table=0&criteriumColumn=<%=Label.APPLICATION_STATE.getNameRaw()%>&criterium=<%=ApplicationState.ACCEPTED.getNameRaw()%>&negate=yes">Vypsat seznam uchazečů.</a></p>
                    ...
                    <p><a href="applicants?table=0&criteriumColumn=<%=Label.APPLICATION_STATE.getNameRaw()%>&criterium=<%=ApplicationState.NOT_CHECKED.getNameRaw()%>">Vypsat seznam notcheckedých uchazečů.</a></p>
